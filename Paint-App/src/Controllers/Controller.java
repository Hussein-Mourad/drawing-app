...
public class Controller {
    ...
    private String imgDir = File.separator + "Assets" + File.separator + "Images" + File.separator;
    ...
    public void fill() {
        ...
        resetMode();
        fillChecked = true;
        setCustomCursor("fill-cursor.png");
    }
    ...
    public void delete() {
        ...
        resetMode();
        deleteChecked = true;
        setCustomCursor("delete-cursor.png");
    }
    ...
    public void setCustomCursor(String filename) {
        Image image = new ImageIcon(getClass().getResource(imgDir + filename)).getImage();
